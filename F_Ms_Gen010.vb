...
Public Class F_Ms_Gen010
    ...
    Private Sub txt科目集計CD_TextChanged(sender As Object, e As EventArgs) Handles txt科目集計CD.TextChanged

    End Sub

    Private Sub txt会社名_TextChanged(sender As Object, e As EventArgs) Handles txt内訳印刷F1.TextChanged
