...
Public Class F_Ms_OrganiA
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txt組織階層.TextChanged

    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btn階層作成.Click
