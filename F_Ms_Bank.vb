...
Public Class F_Ms_Bank
    ...
    Public Sub Data_Get00()
        ...
        With dt0.Tables("t0")
            If .Rows.Count > 0 Then
                ...
                txt銀行CD.Text = PubCom.ChgNull(.Rows(0)("会社名Kana"), 1)
    ...
    Public Sub Data_Put00S0()
        ...
        command.Parameters.Add("@会社名Kana", SqlDbType.NVarChar).Value = txt銀行CD.Text
    ...
    Private Function Inp_Chk00(ByVal ctxtInp As Control)
        ...
        Select Case ctxtInp.Name
            ...
            Case "txt会社Kana名"
                ctxtInp.BackColor = Color.White
                Dim LenB As Integer = System.Text.Encoding.GetEncoding("Shift_JIS").GetByteCount(txt銀行CD.Text)
                If LenB > 40 Then
    ...
    Private Sub txt会社名_TextChanged(sender As Object, e As EventArgs) Handles txt銀行名.TextChanged
    ...
    Private Sub Label4_Click(sender As Object, e As EventArgs) Handles La支店カナ名.Click
