...
Public Class s
    ...
    Private Sub TextBox58_TextChanged(sender As Object, e As EventArgs) Handles txt預入3.TextChanged

    End Sub

    Private Sub TextBox53_TextChanged(sender As Object, e As EventArgs) Handles txt預入7.TextChanged

    End Sub

    Private Sub TextBox74_TextChanged(sender As Object, e As EventArgs) Handles txt残高3.TextChanged

    End Sub

    Private Sub TextBox68_TextChanged(sender As Object, e As EventArgs) Handles txt残高9.TextChanged
