...
Public Class F_Ms_Organi
    ...
    Private Sub Add_Cmb()
        ...
        u
        CDCmbComp.ValueMember = "ItemCode"
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txt組織階層CD.TextChanged
    ...
    Private Sub GroupBox20_Enter(sender As Object, e As EventArgs)

    End Sub

    Private Sub GroupBox10_Enter(sender As Object, e As EventArgs) Handles GroupBox20.Enter

    End Sub

    Private Sub TextBox1_TextChanged_2(sender As Object, e As EventArgs) Handles txt枝番名.TextChanged
