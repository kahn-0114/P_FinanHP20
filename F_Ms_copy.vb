...
Public Class F_Ms_素材
    ...
    '* 保存処理
    '******************************************************
    Private Sub btnUp00_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim pRet As Boolean = Inp_Chk00(txt区分CD)
        If pRet = False Then Exit Sub
        For Each CtrlItem As Control In Me.GroupBox10.Controls
            If TypeOf CtrlItem Is TextBox Then
    ...
    '* 削除処理
    '******************************************************
    Private Sub btnDel00_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim pRet As Boolean = Inp_Chk00(txt区分CD)
        If pRet = False Then Exit Sub
