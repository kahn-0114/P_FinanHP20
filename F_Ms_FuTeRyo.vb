...
Public Class F_Ms_FuTeRyo
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txt銀行CD.TextChanged
    ...
    Private Sub La電信_Click(sender As Object, e As EventArgs) Handles La電信.Click

    End Sub

    Private Sub txt順番CD_TextChanged(sender As Object, e As EventArgs) Handles txt同一1万00.TextChanged
